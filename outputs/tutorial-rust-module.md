...
Continue with [Method Calls and Supported Types in C++ and Rust](tutorial-method-calls-and-types.md) for call errors, domain errors, custom sync/async timeouts, and the full type surface, including contract-first Rust records and collections. [Producing, Merging and Signing LGX Packages](tutorial-lgx-packages.md) covers the release package workflow.
